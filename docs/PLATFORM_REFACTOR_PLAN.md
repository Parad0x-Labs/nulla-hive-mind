...
- keep runtime provider bootstrap truth shared: default local Ollama plus configured local/remote lanes like vLLM and Kimi should register through one seam so backbone snapshots, doctor/install truth, and API bootstrap do not drift apart
