...
The current `main` checkpoint materially improved one hundred and sixteen areas:
...
| Metric | Value |
|--------|-------|
| Full suite result | `1468 passed, 13 skipped, 12 xfailed, 16 xpassed` |
...
| **CI pipeline** | **Enforced** | GitHub Actions runs lint, matrix tests, build, and the fast LLM acceptance gate on every push. Local full gate currently `1468 passed, 13 skipped, 12 xfailed, 16 xpassed`; check Actions for the latest branch conclusion. |
