...
- keep helper drone candidate fan-out behind `core/model_teacher_pipeline.py` so provider fan-out stays bounded and policy-shaped instead of leaking into every caller
